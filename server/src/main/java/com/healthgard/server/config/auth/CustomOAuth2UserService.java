package com.healthgard.server.config.auth;
...
import com.healthgard.server.config.auth.domain.OAuthAttributes;
import com.healthgard.server.config.auth.domain.SessionUser;
import com.healthgard.server.domain.user.User;
import com.healthgard.server.domain.user.UserRepository;
